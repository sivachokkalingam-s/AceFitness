...
* PATH configuration for Python and Docker
* Converting GUI-based logic to API-based structure

---

## Conclusion

This project demonstrates a complete CI/CD pipeline, transforming a local application into an automated, testable, and portable system.
